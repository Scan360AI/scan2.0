/**
 * =================================================================
 * SCAN360 - Motore di Rendering del Report v2.1 (Corretto)
 * File: /report/assets/js/app.js
 * =================================================================
 */

// --- 1. CONFIGURAZIONE GLOBALE ---
const DATA_FILE_PATH = '/report/data/report_data.json'; // Percorso corretto!
const PAGE_ID = document.body.dataset.pageId;

// --- 2. FUNZIONI DI UTILITY (definite a livello globale dello script) ---
...
// --- 3. FUNZIONI DI RENDERING (definite a livello globale dello script) ---
...
const initChart = (canvasId, chartData, chartOptions = {}) => {
    // ... (Questa funzione rimane identica a prima)
                ...
                callbacks: {
                     label: function(context) {
                         ...
                         if (typeof value === 'number') {
                             ...
                             } else if (context.dataset.label && context.dataset.label.includes('/EBITDA')) {
    ...
    new Chart(ctx, { type: 'bar', data: chartData, options: finalOptions });
};
        ...
        switch (PAGE_ID) {
            case 'dashboard':
                ...
                for (const chartKey in reportData.dashboard.charts) {
                    ...
                    initChart(`${chartKey}Chart`, chart.data, chart.options);
                }
                break;
            case 'parte1_sintesi':
